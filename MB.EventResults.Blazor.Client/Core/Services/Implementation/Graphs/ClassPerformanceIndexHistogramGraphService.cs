...
public class ClassPerformanceIndexHistogramGraphService : IClassPerformanceIndexHistogramGraphService {
  public const string Label = "Class Performance Index (Histogram)";
  ...
  public List<int> GetValues(Runner runner) {
    return GraphHelper.GetValues(runner, p => p.PerformanceIndex);
  }
}